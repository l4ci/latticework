...
- **Change:** Move Brightline Software to a remote-first operating model within 12 months.
- **Organization / unit:** Brightline Software, 220 people (engineering, product, sales, customer success, G&A), single HQ plus two regional offices (Austin, Denver).
- **Date:** 2026-06-19
- **Sponsor:** Dana Okafor, COO (executive sponsor and budget owner).
- **Trigger:** HQ lease expires in 11 months; renewal would cost ~$2.1M/yr. Two of the last five senior engineering offers were lost to remote-first competitors.

---

## 1. Urgency

**The case for why now**, framed to reach people rather than just inform them: *"The lease that anchors us to a model we're already losing talent over runs out in eleven months. We can spend $2.1M renewing a building half-full on any given day, or we can become the kind of company the senior engineers we keep losing actually want to join. The window to choose deliberately closes the day we sign a renewal."*

Evidence was gathered along five angles via parallel inquiry; each returned discrete evidence with reasoning, then pooled and sharpened with the sponsor.

| Angle | Evidence | Reasoning |
|---|---|---|
| Financial | HQ lease renewal ~$2.1M/yr; current badge data shows ~41% average daily occupancy | We are paying full price for a building used at fraction capacity; the lease deadline forces a decision either way |
| Competitive | 2 of last 5 senior eng offers lost explicitly citing remote policy; recruiter notes flag it on ~60% of senior declines | The talent we most need is selecting against us on this exact axis |
| Customer | 3 enterprise renewals slipped last quarter while two key engineers were on notice | Attrition driven by the office mandate is starting to touch delivery and revenue, not just headcount |
...
The coalition must carry enough position power to overrule blockers, credibility to be believed by skeptical managers, and a mix of management muscle and change leadership. It must work as a team, not a reporting committee.

| Member | Role | Brings |
|---|---|---|
| Dana Okafor | COO (sponsor) | Position power, budget authority, executive air cover |
...
The vision will be communicated constantly and through behavior, not one launch memo. The plan assumes it is undercommunicated by orders of magnitude unless it is repeated and modeled.

| Channel | Cadence | Owner | Behavior modeled |
|---|---|---|---|
...
Barriers were inventoried across four lenses via parallel inquiry, then pooled, deduped, and prioritized with the coalition.

| Lens | Barrier | Priority | Removal plan |
|---|---|---|---|
| People | **Austin VP actively undercuts the shift**, signals presence still matters to her reports | **P0** | COO direct conversation: align or transition. A resistant senior manager left standing is the classic killer; this is the gate-blocking item |
| Systems / incentives | Promotion and review criteria reward visibility / "face time" | **P0** | Rewrite review rubric to outcome-based before next cycle; remove presence proxies |
| Skills | Middle managers lack distributed-leadership skill; manage by walking around | P1 | Manager enablement program (Initiative 2); coaching, not just a memo |
| Systems | Tooling assumes co-location (booking, some on-prem dev infra) | P1 | Migrate to async-friendly stack; doc-first decision tooling |
| Structure | Office-anchored team rituals (standups timed to HQ, in-office demos) | P2 | Redesign rituals time-zone-fair; demos recorded async |
...
|---|---|---|---|
| **Two senior eng hires closed in cities with no office** | Announced company-wide with named hires | They explicitly cited remote-first as why they joined | Directly reverses the talent loss that justified the change |
...
|---|---|---|---|
| 1. Urgency | Felt urgency, not nodding? | Cleared (conditional) | Manager urgency was threat-based; carried to 4/5 |
| 2. Coalition | Real power + functions as team? | Cleared | Austin VP gap named, routed to 5 |
| 3. Vision | Communicable in minutes, willing to follow? | Cleared | Not a financial target; restated accurately by test listeners |
| 4. Communication | Volunteer army forming? | Cleared (held 2 wks) | Held for listening sessions until managers shifted "if" → "how" |
| 5. Barriers | Can people actually act? | Cleared | Both P0s (resistant VP, face-time rewards) removed first |
| 6. Short-term wins | Real, visible, attributable? | Cleared | 3 wins in 5 months, each narrated as caused by the change |
| 7. Sustained acceleration | Credibility spent on deeper change? | Cleared (watched) | Highest-risk gate; victory deliberately not declared |
| 8. Anchoring | Tied to results, in norms, safe in succession? | Cleared (provisional) | Lives in hiring/review/promotion, not in a sponsor |
